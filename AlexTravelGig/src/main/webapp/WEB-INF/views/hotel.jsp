...
<h3><security:authorize access="isAuthenticated()">
    		...
    		<security:authorize access="hasRole('USER')">
				<a href="http://localhost:8282/displayGuestBookings">See Your Bookings</a>
...
<div class="col-7 border rounded" style="margin-left:50px;">
	...
	<div id="listHotel">
		...
		<tr><th>Hotel Name</th><th>Image</th><th>Price</th><th>Star Rating</th><th>Guest Review Rating</th><th>Written Guest Reviews</th></tr>
		</table>
	</div>
...
<div class="modal" id="bookingHotelRoomModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        	...
        	<div class="col">
	        	...
	        	<div>Customer Mobile: <input class="form-control" type="text" id="booking_customerMobile"/></div>
       			...
       			<div style='margin-top:20px'>
       				<button class='btn-confirm-booking btn btn-primary' id="confirmBookingButton">Confirm Booking</button>
	  ...
	  <div class="modal" id="bookingGuestModal">
		<div class="modal-dialog modal-lg">
		  <div class="modal-content">
			...
			<!-- Modal body -->
			<div class="modal-body" id="bookingGuestModalBody">        
				  <div class="col">
						 <div><input class="form-control" type="hidden" id="booking_GuestId"/></div>
					  <div>First Name: <input class="form-control" type="text" id="guestFirstName"/></div>
					  <div>Last Name: <input class="form-control" type="text" id="guestLastName"/></div>
						 <div>Gender: <input class="form-control" type="text" id="guestGender"/></div>
						 <div>Age: <input class="form-control" type="number" id="guestAge"/></div>      			
						 <div style='margin-top:20px'>
							 <button class='btn-confirm-booking btn btn-primary' id="confirmGuest">Book Rooms</button>
							 <button class='btn btn-primary'>Edit</button>
						 </div>
				  </div>          
			</div>
